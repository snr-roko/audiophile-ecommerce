  ...
  return (
    <div className="lg:flex lg:gap-10">
      ...
      <div className="flex flex-col items-center justify-center w-full gap-3">
        ...
        <div>
          <h2 className="text-[#000000] font-[800] text-2xl md:tracking-wide">{props.title}</h2>
          <h2 className="text-[#000000] font-[800] text-2xl md:tracking-wide">{props.category}</h2>
        </div>
